...
namespace Voronoi
{
    public class Polygons
    {
        ...
        public System.Collections.Generic.List<Point> SiteList = new System.Collections.Generic.List<Point>();
        public System.Collections.Generic.Stack<Point> Sites = new System.Collections.Generic.Stack<Point>();
        public System.Collections.Generic.Dictionary<int, Cell> Cells = new System.Collections.Generic.Dictionary<int, Cell>();
        ...
        private System.Collections.Generic.Stack<Beach> BeachJunkyard = new System.Collections.Generic.Stack<Beach>();
        private System.Collections.Generic.Stack<Circle> CircleJunkyard = new System.Collections.Generic.Stack<Circle>();
        ...
        public void Reset()
        {
            ...
            {
                throw new Exception("Error in Reset", ex);
            }
        }
        ...
        public void Compute()
        {
            ...
            {
                throw new Exception("Error in Compute", ex);
            }
        }
        ...
        private int SortSites(Point a, Point b)
        {
            ...
            {
                throw new Exception("Error in SortSites", ex);
            }
        }
        ...
        private void AddBeach(Point objSite)
        {
            ...
            {
                throw new Exception("Error in AddBeachSection", ex);
            }
        }
        ...
        private double LeftBreakPoint(RBNode objNode, double dblDirectrix)
        {
            ...
            {
                throw new Exception("Error in LeftBreakPoint", ex);
            }
        }
        ...
        private double RightBreakPoint(RBNode objNode, double dblDirectrix)
        {
            ...
            {
                throw new Exception("Error in RightBreakPoint", ex);
            }
        }
        ...
        private Beach CreateBeach(Point objSite)
        {
            ...
            {
                throw new Exception("Error in CreateBeachSection", ex);
            }
        }
        ...
        private void DetachCircleEvent(Beach objArc)
        {
            ...
            {
                throw new Exception("Error in DetachCircleEvent", ex);
            }
        }
        ...
        private Edge CreateEdge(Point objSiteLeft, Point objSiteRight, Point objVertexA, Point objVertexB)
        {
            ...
            {
                throw new Exception("Error in CreateEdge", ex);
            }
        }
        ...
        private void AttachCircle(Beach objArc)
        {
            ...
            {
                throw new Exception("Error in AttachCircleEvent", ex);
            }
        }
        ...
        private Circle GetCircle()
        {
            ...
            {
                throw new Exception("Error in GetCircleEvent", ex);
            }
        }
        ...
        private Beach GetBeach()
        {
            ...
            {
                throw new Exception("Error in GetBeachSection", ex);
            }
        }
        ...
        private void RemoveBeach(Beach objBeach)
        {
            ...
            {
                throw new Exception("Error in RemoveBeachSection", ex);
            }
        }
        ...
        private void DetachBeach(Beach objBeach)
        {
            ...
            {
                throw new Exception("Error in DetachBeachSection", ex);
            }
        }
        ...
        private void ClipEdges()
        {
            ...
            {
                throw new Exception("Error in ClipEdges", ex);
            }
        }
        ...
        private Boolean ConnectEdge(Edge objEdge)
        {
            ...
            {
                throw new Exception("Error in ConnectEdge", ex);
            }
        }
        ...
        private Boolean ClipEdge(Edge objEdge)
        {
            ...
            {
                throw new Exception("Error in ClipEdge", ex);
            }
        }
        ...
        private void CloseCells()
        {
            ...
            {
                throw new Exception("Error in CloseCells", ex);
            }
        }
        ...
        private Edge CreateBorderEdge(Point objSite, Point objVertexA, Point objVertexB)
        {
            ...
            {
                throw new Exception("Error in CreateBorderEdge", ex);
            }
        }

        private System.Collections.Generic.Dictionary<string, Point> EdgeVertices = new System.Collections.Generic.Dictionary<string, Point>();
        ...
        private Point CreateEdgeVertex(double dblX, double dblY)
        {
            ...
            {
                throw new Exception("Error in CreateEdgeVertex", ex);
            }
        }
    }
}
